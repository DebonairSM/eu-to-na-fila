    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0a0a0a] via-[#1a1a1a] to-[#2d2416] relative">
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-5 pt-16 sm:pt-[96px] pb-10 max-w-[520px] animate-in fade-in slide-in-from-bottom-4 duration-500">
        <div className="space-y-6 sm:space-y-7">
          ...
          {/* Waiting State */}
          {isWaiting && (
            <div className="main-card bg-gradient-to-br from-[rgba(212,175,55,0.15)] to-[rgba(212,175,55,0.05)] border-2 border-[rgba(212,175,55,0.3)] rounded-3xl p-6 sm:p-10 text-center mb-6 w-full mx-auto">
          ...
          <div className="space-y-4">
            {isWaiting && (
              <button
                className="w-full px-3 py-2 bg-[#ef4444] text-white font-semibold rounded-lg flex items-center justify-center gap-2 hover:bg-[#dc2626] transition-all disabled:opacity-50 min-h-[40px] text-sm"
            ...
            {isCompleted && (
              <Link to="/mineiro/home">
                <button className="w-full px-3 py-2 bg-gradient-to-r from-[#D4AF37] to-[#E8C547] text-[#0a0a0a] font-semibold rounded-lg flex items-center justify-center gap-2 hover:shadow-[0_10px_30px_rgba(212,175,55,0.3)] transition-all min-h-[40px] text-sm">
            ...
            <Link to="/mineiro/home">
              <button className="w-full px-3 py-2 bg-transparent text-[rgba(255,255,255,0.7)] border-2 border-[rgba(255,255,255,0.3)] rounded-lg hover:border-[#D4AF37] hover:text-[#D4AF37] transition-all min-h-[40px] flex items-center justify-center gap-2 text-sm">
                Voltar
              </button>
            </Link>
          </div>
