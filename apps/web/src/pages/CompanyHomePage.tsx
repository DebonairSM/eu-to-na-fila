  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#071124] via-[#0b1a33] to-[#0e1f3d] text-white">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-16 space-y-16">
        {/* Hero */}
        <section className="flex flex-col items-center text-center gap-9 sm:gap-12">
          ...
          <div className="relative w-full max-w-4xl">
            ...
            <div className="relative rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl p-10 space-y-6 shadow-2xl shadow-black/40 text-left">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={card.title} className="rounded-xl border border-white/10 bg-white/5 px-5 py-4 shadow-[0_10px_30px_rgba(0,0,0,0.25)]">
                    <div className="flex items-center gap-3">
                      <span className="material-symbols-outlined text-[#D4AF37] text-xl">{card.icon}</span>
        ...
        <section className="max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mt-4 text-center">
          {[
