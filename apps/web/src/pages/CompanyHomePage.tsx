...
export function CompanyHomePage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#071124] via-[#0b1a33] to-[#0e1f3d] text-white">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-5 py-10 sm:py-14 space-y-16">
        <section className="flex flex-col items-center text-center gap-12 px-2">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/8 border border-white/12 text-[#8ad6b0] text-xs font-semibold uppercase tracking-[0.28em] animate-pulse">
            Virtual lines • Florianópolis, SC
          </div>
          <h1 className="text-5xl font-semibold leading-tight max-w-4xl drop-shadow-[0_10px_30px_rgba(0,0,0,0.35)]">
          ...
          <div className="relative w-full max-w-4xl">
            ...
            <div className="relative rounded-[28px] border border-white/10 bg-white/5 backdrop-blur-2xl p-12 space-y-7 shadow-2xl shadow-black/40 text-left">
              <h2 className="text-3xl font-semibold text-white drop-shadow">Fila, presença e atendimento</h2>
        ...
        <section className="max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6 text-center">
          {[
