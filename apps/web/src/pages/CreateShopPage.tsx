              ...
              <div className="space-y-6">
                ...
                <section className="p-4 rounded-xl bg-white/5 border border-white/10 space-y-4">
                  ...
                  <ul className="space-y-4">
                    {[{ key: 'requirePhone' as const, labelKey: 'management.requirePhone' }, { key: 'allowDuplicateNames' as const, labelKey: 'management.allowDuplicateNames' }, { key: 'deviceDeduplication' as const, labelKey: 'management.deviceDeduplication' }, { key: 'allowCustomerCancelInProgress' as const, labelKey: 'management.allowCustomerCancelInProgress' }, { key: 'allowAppointments' as const, labelKey: 'management.allowAppointments' }].map(({ key, labelKey }) => (
                      <li key={key}>
