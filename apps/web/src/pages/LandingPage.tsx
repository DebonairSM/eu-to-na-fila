    ...
    <div className="min-h-screen bg-background">
      ...
      <section id="main-content" className="hero relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="hero-content relative z-10 text-center px-4 sm:px-5 max-w-[900px] mx-auto">
          ...
          <h1 className="hero-title font-['Playfair_Display',serif] text-[clamp(2.2rem,7vw,4.5rem)] sm:text-[clamp(2.8rem,7vw,5.5rem)] font-bold leading-[1.1] mb-4 sm:mb-6 fade-in-up" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="hero-actions flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-stretch sm:items-center fade-in-up" style={{ animationDelay: '0.6s' }}>
            <Link to="/join">
              <Button size="lg" className="bg-[#D4AF37] text-[#0a0a0a] hover:bg-[#E8C547] hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(212,175,55,0.3)] transition-all gap-2 sm:gap-3 w-full sm:w-auto">
                <span className="material-symbols-outlined text-xl">person_add</span>
                Entrar na Fila
              </Button>
            </Link>
            <a href="#location">
              <Button variant="outline" size="lg" className="bg-transparent text-white border-2 border-[rgba(255,255,255,0.3)] hover:border-[#D4AF37] hover:text-[#D4AF37] gap-2 sm:gap-3 w-full sm:w-auto">
