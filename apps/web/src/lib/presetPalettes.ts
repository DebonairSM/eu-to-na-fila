...
export const PRESET_PALETTES: Record<StylePresetId, PresetPalette[]> = {
  ...
  vintage: [
    { label: 'Sépia e marrom', theme: { primary: '#44403c', accent: '#57534e', background: '#fef3c7', surfacePrimary: '#fef9c3', surfaceSecondary: '#fef08a', navBg: '#fef3c7', textPrimary: '#292524', textSecondary: 'rgba(41,37,36,0.75)', borderColor: 'rgba(120,113,108,0.4)', textOnAccent: '#fef3c7', accentHover: '#78716c' } },
    { label: 'Verde vintage', theme: { primary: '#365314', accent: '#65a30d', background: '#1c1917', surfacePrimary: '#292524', surfaceSecondary: '#44403c', navBg: '#1c1917', textPrimary: '#ecfccb', textSecondary: 'rgba(236,252,203,0.8)', borderColor: 'rgba(77,124,15,0.35)', textOnAccent: '#1c1917', accentHover: '#84cc16' } },
    ...
    { label: 'Papel envelhecido', theme: { primary: '#57534e', accent: '#57534e', background: '#f5f5f4', surfacePrimary: '#e7e5e4', surfaceSecondary: '#d6d3d1', navBg: '#f5f5f4', textPrimary: '#1c1917', textSecondary: 'rgba(28,25,23,0.75)', borderColor: 'rgba(120,113,108,0.35)', textOnAccent: '#f5f5f4', accentHover: '#78716c' } },
  ...
  industrial: [
    { label: 'Concreto e laranja', theme: { primary: '#27272a', accent: '#ea580c', background: '#18181b', surfacePrimary: '#27272a', surfaceSecondary: '#3f3f46', navBg: '#18181b', textPrimary: '#fafafa', textSecondary: 'rgba(250,250,250,0.75)', borderColor: 'rgba(255,255,255,0.12)', textOnAccent: '#0a0a0a', accentHover: '#f97316' } },
