...
export interface BarbersApi {
  ...
  createBarber(shopSlug: string, data: { name: string; avatarUrl?: string | null; email?: string | null; phone?: string | null; username?: string; password?: string }): Promise<Barber>;
  updateBarber(barberId: number, data: { name?: string; avatarUrl?: string | null; email?: string | null; phone?: string | null; username?: string | null; password?: string; revenueSharePercent?: number | null }): Promise<Barber>;
