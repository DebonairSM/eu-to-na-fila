...
5. **display-screen.html** - Public TV Display
...
6. **login-modal.html** - Staff Login Modal
...
4. **display-screen.html**: Watch the 15s queue + 10s ad rotation
5. **login-modal.html**: Test with admin/admin123 or wrong credentials
